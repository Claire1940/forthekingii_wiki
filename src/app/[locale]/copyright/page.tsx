...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - For The King II Wiki',
    description: 'Copyright and intellectual property information for For The King II Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - For The King II Wiki',
      description: 'Copyright and intellectual property information for For The King II Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 For The King II Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of For The King II Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              For The King II Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>IronOak Games</strong> - Developers of For The King II</li>
              <li><strong>Curve Games</strong> - Publisher of For The King II</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>For The King II</strong> - Trademark of IronOak Games and Curve Games</li>
              <li><strong>For The King II Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with For The King II Wiki.
            </p>
            ...
            <p>
              ...
              For The King II Wiki<br />
              Email: <a href="mailto:dmca@forthekingii.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@forthekingii.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "For The King II Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: For The King II Wiki (forthekingii.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@forthekingii.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@forthekingii.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@forthekingii.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@forthekingii.wiki</a>
            </p>
            <p>
